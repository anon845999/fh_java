...
public class BattleShipGameManager {
   ...
   private BattleShipGameManager(){}
    ...
    public static class BattleShipGameManagerInstance{
        ...
        public void startGame(){
            ...
            while(isBoardNotYetCreated){
                ...
                userInputAsText = userInput.getRawUserInput();
                userInput.tryParseToInteger(userInputAsText);
    ...
    public int[] getCoordinatesFromUserToSetNextMove(UserInput userInput)throws NumberFormatException{
      if(userInput != null){
          int[] coordinates = new int[2];
          System.out.println("on which coordinates u wanna make ur next move?:(x,y) ");
          System.out.println("Gimme x coordinates: ");
          userInput.setRawUserInput(userInput.getUserInput());
          userInput.setIntegerValue(userInput.tryParseToInteger(userInput.getRawUserInput()));
          coordinates[0] = userInput.getIntegerValue();
          System.out.println("Gimme y coordinates: ");
          userInput.setRawUserInput(userInput.getUserInput());
          userInput.setIntegerValue(userInput.tryParseToInteger(userInput.getRawUserInput()));
          coordinates[1] = userInput.getIntegerValue();
          return coordinates;
      }
      return null;
