...
//        readerwriter.setStrategy(new CreateICsvStrategy());
//
//
       CTournamentManager manager = CTournamentManager.getInstance();

       manager.startTournament(ETournamentname.CHESS);
       manager.startTournament(ETournamentname.MTB);
